...
//微博以及订阅设置
	...
	array(	"name" => "QQ空间",
            "desc" => "",
            "id" => $shortname."_qzoneurl",
            "type" => "textarea",
            "std" => "http://673340170.qzone.qq.com"),
...
//广告设置
	...
	array(	"name" => "输入导航右微博下广告代码(468X22)",
            "desc" => "",
            "id" => $shortname."_addcode",
            "type" => "textarea",
            "std" => ""),
	...
	array(	"name" => "输入底部广告代码(960x90)",
            "desc" => "",
            "id" => $shortname."_addbcode",
            "type" => "textarea",
            "std" => ""),
