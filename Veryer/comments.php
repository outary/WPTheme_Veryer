...
<?php if ($comments) : ?>
	...
	<?php wp_list_comments('type=comment&callback=veryer_comment&end-callback=veryer_end_comment&max_depth=23'); ?>
	</ol>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<div id="comment-author-info">
		<p>
			...
			<label for="author">爱称<?php if ($req) echo " *"; ?></label>
		</p>
		<p>
			<input type="text" name="email" id="email" class="commenttext" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
			<label for="email">邮箱<?php if ($req) echo " *"; ?> <a id="Get_Gravatar"  title="查看如何申请一个自己的Gravatar全球通用头像" target="_blank" href="http://zycao.com/gravatar.html">（教你设置自己的个性头像）</a></label>
		</p>
		<p>
