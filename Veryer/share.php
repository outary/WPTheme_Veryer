   ...
   <div id="share_toolbar"> 
    ...
    <div data="{'url':'<?php the_permalink()?>'}" class="bdshare_t bds_tools get-codes-bdshare stb_share_buttons stb_group" id="bdshare"> 
     ...
     <a href="javascript:void(0);" class="shareCount">
		<!-- 百度分享代码  -->
		<script type="text/javascript" id="bdshare_js" data="type=tools&amp;uid=45408" ></script>
...
<!-- 滚动后分享工具条改变CSS -->
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/share_roll.js" charset="utf-8"></script>